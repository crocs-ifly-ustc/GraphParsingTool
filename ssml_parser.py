...
def main(args):
    ...
    for ind, line in enumerate(tqdm.tqdm(lines)):
        ...
        for key, chemfig_str in replace_dict.items():
            ...
            out_chemfig_arr.append(chemfig_ops.convert_graph_to_json(root_atom))
        ...
        output_json_path = os.path.splitext(output_img_path)[0] + ".json"
        
        with open(output_json_path, "w") as fout:
            json.dump(out_chemfig_arr, fout, indent=4, ensure_ascii=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-input", type=str, default="mini_valid_ssml_normed.txt")
    parser.add_argument("-img_prefix", type=str, default="./data/mini_valid/mini_valid")
    parser.add_argument("-output", type=str, default="./viz_mini_valid/")
