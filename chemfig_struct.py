...
class Atom(object):
    ...
    def format_to_json(self):
        out_dict = {}
        out_dict["key"] = self.name
        out_dict["text"] = self.m_text
        out_dict["pos_x"] = self.pos_x
        out_dict["pos_y"] = self.pos_y
        return out_dict
...
class Bond(object):
    ...
    def format_to_json(self):
        out_dict = {}
        out_dict["key"] = self.name
        out_dict["type"] = self.m_type
        out_dict["angle"] = self.m_angle
        out_dict["length"] = self.m_length
        out_dict["begin_atom"] = self.begin_atom.name
        out_dict["end_atom"] = self.end_atom.name
        return out_dict
